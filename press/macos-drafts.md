...
Beta. macOS 14+. Homebrew or a signed, notarized DMG. AGPL-3.0. Secure fields can still refuse insertion.
...
I use it every day. AGPL-3.0. https://vocamac.com
...
VocaMac v0.9.0 is a menu-bar dictation app for Apple Silicon. Hold Right Option, talk, text at the cursor. On-device models (WhisperKit / Core ML). No Voca account. AGPL-3.0. I use it every day.
...
Menu-bar dictation on Apple Silicon. Hold Right Option, talk, words at the cursor. The model runs on the Mac. No Voca account. Free, AGPL-3.0. Beta v0.9.0. Signed DMG or Homebrew.
...
I use it every day. I can send a build. Secure fields may refuse insertion; that is a platform limit, not a hidden one.
...
Menu bar. Hold Right Option. Text at the cursor. Models stay on the Mac. No Voca account. AGPL-3.0. Apple Silicon, macOS 14+. Beta v0.9.0. I use it every day.
...
Beta, Apple Silicon, macOS 14+, AGPL-3.0. Homebrew or a signed DMG. vocamac.com
...
v0.9.0 is a Beta menu-bar app for Apple Silicon. On-device speech-to-text. Hold Right Option, text at the cursor. No Voca account. Free AGPL-3.0. Signed, notarized DMG or Homebrew. I use it every day.
...
VocaMac v0.9.0: menu-bar dictation, Apple Silicon, macOS 14+, on-device models, no Voca account. Hold Right Option, talk, text at the cursor. AGPL-3.0. Beta. Homebrew or notarized DMG. I use it every day.
...
Menu-bar dictation for Apple Silicon. Local models. Text at the cursor. No account. Free AGPL-3.0. I use it every day. vocamac.com
