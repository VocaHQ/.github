...
| Linuxiac | info@linuxiac.com | Published [Vocalinux Is an Open-Source Voice Dictation App Built for Linux](https://linuxiac.com/vocalinux-is-an-open-source-voice-dictation-app-built-for-linux/) (18 Jul 2026). |
| LinuxLinks (Steve Emms) | sde@linuxlinks.com | Contacted. FAQ still points pitches to Steve ([FAQ](https://www.linuxlinks.com/faq/)). |
